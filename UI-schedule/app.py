...
class MainWindow(QWidget):
    ...
    def _create_schedule_tab(self):
        ...
        self.day = int(input("Choice day of week (where 1 - Monday, 6 - Saturday)\n"))
        ...
        self.update_schedule_button = QPushButton("Изменить")
    ...
    def _create_one_day_table(self):
        ...
        self.monday_table.setHorizontalHeaderLabels(["Начало", "Предмет", "Преподаватель", "каб.", "Удалить"])
